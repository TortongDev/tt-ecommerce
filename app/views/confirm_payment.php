...
<?php
    ...
    $section_2 = Connection::$pdo->query("SELECT * FROM `kanji_orders` WHERE 1=1 AND ORDER_STATUS = '2' ORDER BY ORDER_ID DESC"); // ยังชำระแล้ว
      ...
      <?php include "./aside-template.php"; ?>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h2>รอ Admin ดำเนินการตรวจสอบการชำระเงินจากลูกค้า</h2>
                        <table class="table">
                            <thead>
                                <tr>
                                    <th>#</th>
